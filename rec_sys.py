...
class RecommendationSystem:
    ...
    def render(self):
        ...
        title_mapping = dict(zip(prettified_titles, self.project_titles))
    
        selected_pretty_project = st.selectbox("Filter recommendations by project:", prettified_titles, index=0)  # Set default as the first project
        selected_project = title_mapping[selected_pretty_project]
