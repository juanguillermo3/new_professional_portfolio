    ...
    def _render_title_with_badges(
        ...
        if verified:
            badges.append(
                ...
                'title="✅ This section has been reviewed for a responsible use of AI-generated content. '
                'It mostly provides accurate information.">✔ Verified Content</p>'
            )
        if early_dev:
            badges.append(
                '<p style="font-size: 0.8em; background: #ffc107; color: black; display: inline-block; '
                'padding: 4px 9px; border-radius: 8px; cursor: pointer;" '
                'title="🚧 This section is new, and we are working on delivering its content.">🚧 Early Development</p>'
            )
        if ai_content:
            badges.append(
                '<p style="font-size: 0.8em; background: #17a2b8; color: white; display: inline-block; '
                'padding: 4px 9px; border-radius: 8px; cursor: pointer;" '
                'title="🤖 This section may be using AI-generated content as placeholder data.">🤖 AI Content</p>'
            )
