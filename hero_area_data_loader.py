...
def load_detailed_offering(id_pattern="offering-{}", colors=["#ffee00", "#ffffff"]):
    offerings = [
        {
    ...
    for i, offer in enumerate(offerings):
        ...
        if "skills" in offer:
            offering_html += "<span>"+html_for_tooltip_from_large_list(offer["skills"], label="Technical Skills", element_id=element_id, color="#555", emoji="🏅")+"</span>"
