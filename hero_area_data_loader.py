...
def load_quote():
    return [
        ...
        "Moreover, software automation is key for distributing inferences from statistical analysis, "
        ...
        "implementing them software engineering standards to follow insights in key social/corporate systems. "
