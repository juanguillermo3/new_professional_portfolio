...
def load_quote():
    return [
        ...
        "I consider that my business is discovering the more powerfull abstractions and mental models across the information cycle, "
        "to effectivelly work with data, and information more generally. "
