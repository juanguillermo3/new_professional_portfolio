...
class AboutSection:
    ...
    def render(self):
        ...
        st.markdown(
            ...
            It is quite eclectic as I am not focused on a single vertical but I hope it's representative of some core workflows I enjoy working in. 
            Moreover, ongoing research aims at leveraging emerging technologies like Recommendation Systems (RecSys) and LLM-powered applications (LLM apps)
            to create practical software solutions to practical problem of workers at the laboral market, such as efficiently displaying content to an audience 
