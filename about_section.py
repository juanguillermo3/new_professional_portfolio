...
class AboutSection:
    ...
    def render(self):
        ...
        st.markdown(
            ...
            Recommendation Systems (RecSys) and LLM-powered applications (LLM apps) to create practical software solutions to practical problem of workers at the laboral market, such as efficiently displaying content to an audience 
